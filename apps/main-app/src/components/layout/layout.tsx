...
const Layout = ({children,footer: Footer,header: Header,sidebar: Sidebar}: LayoutProps) => {
  ...
  return (
    ...
    >
      <Sidebar className="bg-sky-900 text-white" style={{ gridArea: 'sidebar' }}/>
      <Header className="bg-white text-center" style={{ gridArea: 'header' }}/>
      <div className="bg-gray-100 text-center p-4" style={{ gridArea: 'main' }}>
